	...
	return (
		<section class="w-screen h-screen relative">
			...
			<div class="absolute w-full h-full grid grid-cols-[1fr,1fr,1fr] place-items-center">
				...
				<div class="scale-90 translate-y-16">
					<Steckbrief data={!steckbriefe.loading && steckbriefe()[wrap(0)]} /></div>
				<div class="scale-100 translate-y-7">
					<Steckbrief data={!steckbriefe.loading && steckbriefe()[wrap(1)]} /></div>
				<div class="scale-90 translate-y-16">
					<Steckbrief data={!steckbriefe.loading && steckbriefe()[wrap(2)]} /></div>
			</div>
			...
			<div class="absolute left-12 top-12 bg-white bg-opacity-70 backdrop-blur-md rounded-2xl p-5">
				<img src="/logos/Spengergasse.svg" alt="Spengergasse" class="h-28" />
			</div>
